...
Page({
   ...
   * 输入电剩余量
   */
  electricityRemainChange: function (e) {
    this.setData({
      electricityRemain: Math.ceil(e.detail.value)
    })
  },
  ...
  callSubmit: function (e) {
    ...
    if (!self.data.electricityRemain && self.data.electricityRemain !== 0) {
      jsUtil.formErrTip({
        title: '请填写冷水表剩余量'
      })
      return
    ...
    var postData = {
      ...
      electricityRemain: self.data.electricityRemain,
      formId: formId
    }

    jsUtil.sessionRequest({
      url: '/app/bankcard/book/electricityRefund',
      data: postData,
      success: function () {
  ...
  onLoad: function (options) {
    ...
    jsUtil.sessionRequest({
      url: '/app/bankcard/book/electricityRefund/openId/' + app.globalData.openId + '/last',
      method: 'GET',
      success: function (res) {
        ...
        self.setData({
          ...
          electricityRemain: res.electricityRemain ? res.electricityRemain : 0,
          hasBook: res.hasBook,
